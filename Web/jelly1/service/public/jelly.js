  ...
  Stage = (function () {
        ...
        for (
          ...
          _results.push(
            function () {
              ...
              _results2 = [];
              for (
                x = 0, _ref2 = row.length;
                0 <= _ref2 ? x < _ref2 : x > _ref2;
                0 <= _ref2 ? x++ : x--
              ) {
                color = null;
    ...
    Stage.prototype.addBorders = function () {
      var attr,
        ...
        _ref5;
      for (
        y = 0, _ref = this.cells.length;
        0 <= _ref ? y < _ref : y > _ref;
        0 <= _ref ? y++ : y--
      ) {
        for (
          x = 0, _ref2 = this.cells[0].length;
          0 <= _ref2 ? x < _ref2 : x > _ref2;
          0 <= _ref2 ? x++ : x--
        ) {
          cell = this.cells[y][x];
      ...
      while (!done) {
        ...
        for (_i = 0, _len = jellies.length; _i < _len; _i++) {
          ...
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            ...
            if (((_ref3 = next.jelly), __indexOf.call(jellies, _ref3) >= 0))
              continue;
